...
Source0  : https://download.kde.org/stable/applications/18.12.2/src/ksmtp-18.12.2.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.2/src/ksmtp-18.12.2.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1549874072
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKPimSMTP.so.5.10.2
