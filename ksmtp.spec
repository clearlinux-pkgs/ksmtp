...
Version  : 22.08.3
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.08.3/src/ksmtp-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/ksmtp-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/ksmtp-22.08.3.tar.xz.sig
...
%prep
%setup -q -n ksmtp-22.08.3
cd %{_builddir}/ksmtp-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667861674
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimSMTP.so.5.21.3
