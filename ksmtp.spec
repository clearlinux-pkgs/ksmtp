...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/ksmtp-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/ksmtp-23.04.0.tar.xz.sig
...
%prep
%setup -q -n ksmtp-23.04.0
cd %{_builddir}/ksmtp-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682016989
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim5SMTP.so.5.23.0
