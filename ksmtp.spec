...
Version  : 19.04.3
Release  : 11
URL      : https://download.kde.org/stable/applications/19.04.3/src/ksmtp-19.04.3.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.3/src/ksmtp-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/ksmtp-19.04.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562880548
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimSMTP.so.5.11.3
