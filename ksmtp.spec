...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/ksmtp-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/ksmtp-24.05.2.tar.xz.sig
...
%setup -q -n ksmtp-24.05.2
cd %{_builddir}/ksmtp-24.05.2
pushd ..
cp -a ksmtp-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720568157
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6SMTP.so.6.1.2
/usr/lib64/libKPim6SMTP.so.6
/usr/lib64/libKPim6SMTP.so.6.1.2
