...
Source0  : https://download.kde.org/stable/applications/19.08.0/src/ksmtp-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/ksmtp-19.08.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565908114
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimSMTP.so.5.12.0
