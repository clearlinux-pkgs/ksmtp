...
Source0  : https://download.kde.org/stable/applications/19.08.1/src/ksmtp-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/ksmtp-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567709761
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimSMTP.so.5.12.1
