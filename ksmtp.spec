...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/ksmtp-22.08.0.tar.xz
...
%prep
%setup -q -n ksmtp-22.08.0
cd %{_builddir}/ksmtp-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661537065
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPimSMTP.so.5.21.0
